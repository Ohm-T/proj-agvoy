 ...
 */
final class Version20211013153152 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment_table (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, reservation_id INTEGER NOT NULL, content CLOB DEFAULT NULL COLLATE BINARY)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_9474526CB83297E7 ON comment_table (reservation_id)');
